            ...
            'history': [
                ...
                },
                {
                    ...
                    'changes': [
                        ...
                        'time_from_source_window convergence improved: max iterations raised to 20, convergence criterion changed to SNR-relative tolerance 1e-4 (0.01%), NDIT sub-1 case exits after one exact analytical step, no artificial floor on param_val during iteration. NDIT bracket detection: loop exits as soon as consecutive integers N and N+1 straddle the target SNR (~3 iterations instead of 20). DIT secant acceleration: from iteration 2 onward the next DIT is the linear interpolation of the last two (DIT, SNR) points, reducing typical DIT convergence from 20 to ~4 iterations.',
